...
exports.up = (pgm) => {
  ...
  pgm.addConstraint('playlist_activities', 'unique_playlist_id_and_song_id_and_user_id', 'UNIQUE(playlist_id, song_id, user_id)');
...
exports.down = (pgm) => {
  ...
  pgm.dropConstraint('playlist_activities', 'unique_playlist_id_and_song_id_and_user_id');
